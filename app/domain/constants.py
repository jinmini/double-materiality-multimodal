...
AUTO_INDUSTRY_DETECTION = {
    "전력": ["발전", "전력", "한국전력", "전기", "원자력", "화력", "신재생", "송전", "배전", "변전소"],
    "제조": ["제조", "생산", "공장", "설비", "철강", "화학", "자동차", "조선", "기계"],
    "금융": ["은행", "보험", "증권", "금융", "카드", "대출", "투자", "자산운용"],
    "건설": ["건설", "시공", "부동산", "아파트", "인프라", "토목", "건축"],
    "유통": ["유통", "마트", "백화점", "온라인", "물류", "배송", "소매"],
    "IT": ["IT", "소프트웨어", "플랫폼", "인터넷", "게임", "클라우드", "AI"],
    "통신": ["통신", "네트워크", "5G", "데이터", "인터넷", "모바일"],
    "항공": ["항공", "공항", "항공기", "운항", "승객", "화물"],
    "해운": ["해운", "선박", "항만", "컨테이너", "물류", "선원"]
}
